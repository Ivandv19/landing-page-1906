...
const SocialIcon: FC<SocialIconProps> = ({ href, label, children }) => (
	<a
		href={href}
		aria-label={label}
		className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 text-slate-500 hover:bg-blue-600 hover:text-white transition-all duration-300 dark:bg-slate-800 dark:text-slate-400 dark:hover:bg-blue-500"
	>
		<svg
					...
					<div>
						...
						<form className="flex flex-col gap-2">
							<input
								...
								className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm placeholder:text-slate-400 focus:border-blue-600 focus:outline-none focus:ring-1 focus:ring-blue-600 dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:placeholder:text-slate-500"
							/>
							<button
								type="button"
								className="w-full rounded-md bg-slate-900 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-slate-800 transition-colors dark:bg-blue-600 dark:hover:bg-blue-500"
							>
